...
from tkinter import Tk, Canvas, BOTH, Frame, mainloop
    ...
    while t1.live or balls:
        for b in balls:
            ...
            if b.hit_test(t1) and t1.live:
                ...
                if (bullet % 10) == 1 and (bullet != 11):
                    canvas.itemconfig(screen1,
                                      text='Вы уничтожили цель за ' + str(bullet) + ' выстрел')
                elif ((bullet % 10) == 2 and bullet != 12)\
                        or ((bullet % 10) == 3 and bullet != 13) \
                        or ((bullet % 10) == 4 and bullet != 14):
                    canvas.itemconfig(screen1,
                                      text='Вы уничтожили цель за ' + str(bullet) + ' выстрела')
                else:
                    canvas.itemconfig(screen1,
